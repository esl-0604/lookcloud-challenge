...
import { TutorialPageContext } from "../service/challenge/tutorial/main"

export default function Page10Main() {
	const { tutorialPageNum, setTutorialPageNum }: any =
		useContext(TutorialPageContext)

	return (
		<div className="pl-4 pr-4 w-[100%] h-[100%] flex flex-col items-center bg-black opacity-75">
			<div>
