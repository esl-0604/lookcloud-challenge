    ...
    return (
        <div className="flex-1 flex flex-col justify-start items-center w-[100%] font-textBoxFont">
            <div className="flex relative justify-center items-start w-[100%] h-[124px] py-[8px] overflow-hidden">
                <img
                    src="/image/challengethumbnail_3.png"
                    alt="challengeImg"
                    className="flex justify-center items-start w-[100%] h-[108px] object-cover"
                />
                <div
                    id="gradation_warpper"
                    className="flex flex-col justify-center items-start absolute w-[100%] h-[108px] text-white"
                >
                    ...
                    <div className="flex flex-col justify-center items-start w-[100%] pl-[20px] h-[48px] text-[12px]">
                        ...
                        <div className="">고연전 패션왕에 도전하세요!</div>
                    </div>
                </div>
            </div>
